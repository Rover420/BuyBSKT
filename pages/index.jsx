        ...
        <div className={styles.main}>
            ...
            <div className={styles.wrapper}>
                ...
                <form onSubmit={start} className={styles.panelwrapper}>
                    ...
                    <h2 className={styles.fadein}>Jak to działa?</h2>
                    <div className={`${styles.panelwrapper} ${styles.videowrapper}`}>
                    <iframe style={{ borderRadius: '10px', width: '100%', height: '100%' }} title="BasketCoin - Jak to działa [PL] - 90 sek" src="https://www.youtube.com/embed/Tqa1M8KQyMo" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe>
                    </div>
